    ...
    public partial class Form1 : Form
    {
        ...
        private async void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //Получение данных и запись в answer
                ...
                {
                    MessageBox.Show("Wrong city name.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    this.Close();
                }

                //создание объекта, хранящего в себе информацию о погоде
                ...
                label1.Text = open_w.name + ", " + open_w.sys.country;
                label2.Text = open_w.weather[0].main;
                label3.Text = open_w.weather[0].description;
                label4.Text = open_w.main.temp.ToString("0.#") + "°C";
                label5.Text = "Humidity: " + open_w.main.humidity.ToString() + "%";
                label6.Text = "Pressure: " + open_w.main.pressure.ToString("0.") + " mm";
                label7.Text = "Speed: " + open_w.wind.speed.ToString() + "Km/H";
                label8.Text = "Direction: " + open_w.wind.deg.ToString("0.#") + "°";
            }
        }

        //тот же код по нажатию Enter
